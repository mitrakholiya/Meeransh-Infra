            ...
            <div className='pt-[150px] md:px-[15%] flex flex-col gap-[40px]'>
                {
                    ServicesData.map(v => (
                        <div className="" key={v.id}>
                            ...
                            <div className={v.id % 2 == 0 ? "flex flex-row-reverse" : "flex"}>
                                <img src={v.path} alt="" className='max-w-[350px]' />
                                <div className='min-w-[350px]  w-[400px]  rounded-[20px] bg-[#f8f8f8] flex flex-col  justify-center sm:px-[25px] px-[15px]'>
                                    <h4
